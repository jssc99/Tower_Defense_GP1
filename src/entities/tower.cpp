...
void Tower::draw()
{
	...
	bgDrawList->AddCircleFilled({ this->pos.x, this->pos.y }, this->mActionRadius, SHY_LIGHT_BLUE);
...
{																																// 10 == enemy radius TODO 
	return (pow(en->pos.x - this->pos.x, 2.f) + pow(en->pos.y - this->pos.y, 2.f) < pow(10 + this->mActionRadius, 2.f));
}
